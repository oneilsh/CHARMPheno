...
Seed: 0. Config: K=4 (bg_k=2, groups=['A', 'B'], fg_per_group=1), V=100, D=300, doc_len=55, holdout_frac=0.3, Sigma=identity (R = I; c IS the generative eta-variance), c_grid=[1, 2, 3, 5, 8, 12, 20].
