...
# NOTE: the former `test_synthetic_recovery_full_batch` (a qualitative Γ̂ sign-match >= 0.75
# check on a seeded 30-iter full-batch fit) was REMOVED 2026-07-24. It was fragile by design
# (a sign-pattern threshold on an L-BFGS fit is sensitive to float-reduction order across
