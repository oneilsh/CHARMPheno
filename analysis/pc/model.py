"""Driver-facing wrapper around the factored PC objective: a small, real
``PCTopicModel`` with an sklearn-flavored ``fit`` / ``transform`` /
``predict_proba`` surface.

This is the in-memory reference API. It owns no math beyond wiring: ``fit``
