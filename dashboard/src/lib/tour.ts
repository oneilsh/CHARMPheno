...
const BASIC_STEPS: StepDef[] = [
  ...
  // ── Simulator · Simulate ── (a default population is present on arrival;
  // the run panel sits on top, its inputs below, in DOM order.)
  ...
  { id: 'sampleMix', tab: 'sim', sub: 'simulate', selector: '[data-tour="sample-mix"]', on: 'left' },
